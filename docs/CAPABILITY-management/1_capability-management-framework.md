...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#FFB6C1', 'primaryTextColor':'#000', 'primaryBorderColor':'#FF1493', 'secondaryColor':'#87CEEB', 'tertiaryColor':'#228B22', 'quaternaryColor':'#9370DB'}}}%%
mindmap
